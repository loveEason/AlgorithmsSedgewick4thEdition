 ...
 *  Dependencies: ThreeSumFast.java Stopwatch.java StdRandom.java StdOut.java
 *
 *
 *  % java DoublingRatio
 *      250   0.0    2.7
...
public class DoublingRatio {
    ...
    /**
     * Returns the amount of time to call <tt>ThreeSumFast.count()</tt> with <em>n</em>
     * random 6-digit integers.
     * @param n the number of integers
     * @return amount of time (in seconds) to call <tt>ThreeSumFast.count()</tt>
    ...
    /**
     * Prints table of running times to call <tt>ThreeSumFast.count()</tt>
